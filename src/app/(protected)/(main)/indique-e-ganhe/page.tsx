...
import { PublicMapDialogTrigger } from './dialogs/share-material'
import { ShareMaterialDialogTrigger } from './dialogs/public-map'
    ...
    <ProtectedRoute level="non-trial">
      <div className="relative" ref={containerRef}>
        ...
        <div className="flex flex-col w-full relative min-h-screen items-center gap-8 md:gap-16 overflow-y-auto scrollbar-minimal">
          ...
          <div className="w-full h-1 bg-zinc-800" />
          <section
            className="flex flex-col w-full max-w-8xl gap-6 p-4 pb-32"
            data-tutorial-id="courses-affiliates"
          >

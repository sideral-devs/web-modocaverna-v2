...
export function CodeDialogTrigger({ children }: { children: ReactNode }) {
        ...
        <div className="relative w-full h-full overflow-hidden">
          <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col relative w-full p-6 gap-6 border border-zinc-700 rounded-lg">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-zinc-400">
                    Assista ao vídeo para entender como encontar o seu código
                  </p>
                </div>
                <Image
            ...
            <div className="w-full aspect-video rounded-xl overflow-hidden">
              <VideoPlayer id={videos.codeTutorial} />
            </div>

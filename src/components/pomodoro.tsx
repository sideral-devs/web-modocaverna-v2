...
import { ClockIcon, Pause, Play, Settings } from 'lucide-react'
    ...
    <Card className="flex flex-col w-full h-96 p-5 gap-2">
      <div className="flex w-full items-center justify-between relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
          <button
            className={cn(
              'flex w-fit items-center px-3 h-8 gap-1 border rounded-lg',
        ...
        <ConfigPomodoroDialogTrigger>
          <Button variant="outline" className="border h-8 text-[10px]">
            <Settings />
          </Button>
        </ConfigPomodoroDialogTrigger>
      </div>

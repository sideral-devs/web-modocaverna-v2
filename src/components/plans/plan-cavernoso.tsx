    ...
    <div className="flex  w-80 bg-gradient-to-b from-[#2a2a2a] from-[12%] to-zinc-900 rounded-2xl">
      <div className="flex flex-col py-8 gap-6 w-full">
        <div className="flex items-center justify-center">
          <h3 className=""> Plano Cavernoso </h3>
        ...
        <div className="flex flex-col pb-5 px-6 gap-6 ">
          <span className="flex w-fit px-3 py-1 text-xs font-semibold text-yellow-700 bg-yellow-200 rounded-full">
          ...
          <ul className="flex flex-col gap-5">
            ...
            <li className="flex items-center gap-4">
              <Check size={16} className="text-emerald-400" />
              <span className="text-xs text-zinc-400">Flow Produtividade</span>
            </li>
            <li className="flex items-center gap-4">
              <Check size={16} className="text-emerald-400" />
              <span className="text-xs text-zinc-400">
